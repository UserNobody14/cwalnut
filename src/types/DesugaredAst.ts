...
export type TermDsAst = ConjunctionDsAst | DisjunctionDsAst | FreshDsAst | WithDsAst | PredicateCallDsAst | PredicateDefinitionDsAst;
...
export type ExpressionDsAst = IdentifierDsAst | LiteralDsAst;
