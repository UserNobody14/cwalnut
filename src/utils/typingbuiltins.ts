import { InOutType, TypeMeta, Type, MonoPredicateType, Union, TypeVar, HKT, ComplexType, SimpleType } from '../types/Types';
import { IdentifierTyped } from '../types/DesugaredAstTyped';

// export type boundType = SimpleType | Union | MonoPredicateType;
// Utilities
export const to_type_meta = (inout: InOutType = 'inout', linear: boolean = false): TypeMeta => ({
    inout,
    linear
