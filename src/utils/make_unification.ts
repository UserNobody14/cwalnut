import { Expression, LVarAst, LiteralAst, AttributeAst, BinaryOperatorAst, UnaryOperatorAst, ListAst, DictionaryAst, PredicateDefinitionAst, Term, Conjunction, Disjunction, Unification, PredicateCall } from '../types/OldAstTyped';
...
export const is_lvar_ast = (e: Expression): e is LVarAst => e.type === 'lvar', is_literal_ast = (e: Expression): e is LiteralAst => e.type === 'literal', is_attribute_ast = (e: Expression): e is AttributeAst => e.type === 'attribute', is_binary_operator_ast = (e: Expression): e is BinaryOperatorAst => e.type === 'binary_operator', is_unary_operator_ast = (e: Expression): e is UnaryOperatorAst => e.type === 'unary_operator', is_list_ast = (e: Expression): e is ListAst => e.type === 'list', is_dictionary_ast = (e: Expression): e is DictionaryAst => e.type === 'dictionary', is_predicate_ast = (e: Expression): e is PredicateDefinitionAst => e.type === 'predicate_definition';
...
/////////////////////
export const make_conjunction = (...children: Term[]): Conjunction => ({
    type: 'conjunction',
    children,
