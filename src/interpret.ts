...
// 		case "predicate":
// 			return applyF(
// 				lm.get(t.source.value),
// 				t.args.map((arg) => interpretE(arg, lm)),
// 			);
// 		// return (p: Package) => {
...
// 			});
// 			const freshTerm = argsList.reduce(
// 				(acc, arg, i) =>
// 					SLogic.conj(acc, SLogic.eq(t.args[i], arg)),
// 				buildCompoundLogic(
// 					t.body.terms,
// 					map,
// 					"conjunction",
...
// const listOfStatements = Object.entries(builtins).map(
// 	([key, value]) => {
...
// 	return SLogic.run(
// 		SLogic.and(...listOfStatements, goal),
// 		lvars,
// 	);
// };
