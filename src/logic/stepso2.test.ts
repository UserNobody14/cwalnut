...
import { fresh, fresh2, fresh4, freshNom2, freshNom3, freshNom4, freshNom5, freshNom6 } from "./AnyFreshFn";
import { ezq, ezTie } from './ezeq';
import { availableo } from "./availableo";
import { qvar, qlam, qapp, tieTag, qlam2, qapp2, qvar2, qappVV, stepso, suspTag, lamTie } from './testutils';
                ...
                qlam(
                  makeTie(
                    ...
                    qlam(
                      makeTie(
                        aa2,
                        qapp(qapp(qvar(aa1), qvar(aa2)), qvar(aa2))
                      )
                    )
                ...
                qlam(
                  makeTie(
                    ...
                    qlam(
                      makeTie(
                        aa1,
                        qapp(qapp(qvar(aa0), qvar(aa1)), qvar(aa1))
                      )
                    )
            ...
            tieTag(a0,
              qlam2(
                tieTag(a1,
                  qlam2(
                    tieTag(a2,
                      qapp(qvar(a1), qapp(qvar(a0), qvar(a2)))
                    )
                  )
                )
              )
