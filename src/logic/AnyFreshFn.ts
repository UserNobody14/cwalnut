...
export type AnyFreshFn = ((v: LLVar) => MGoal) | ((v: LLVar, z: LLVar) => MGoal) | ((v: LLVar, z: LLVar, y: LLVar) => MGoal) | ((v: LLVar, z: LLVar, y: LLVar, x: LLVar) => MGoal);
export function freshG(fn: (v: LLVar) => MGoal): MGoal;
export function freshG(fn: (v: LLVar, z: LLVar) => MGoal): MGoal;
export function freshG(fn: (v: LLVar, z: LLVar, y: LLVar) => MGoal): MGoal;
export function freshG(fn: (v: LLVar, z: LLVar, y: LLVar, x: LLVar) => MGoal): MGoal;
export function freshG(fn: AnyFreshFn): MGoal {
    ...
    if (fnArity === 1) {
        ...
        return fresh3(fn as (v: LLVar, z: LLVar, y: LLVar) => MGoal);
    } else if (fnArity === 4) {
        return fresh4(fn as (v: LLVar, z: LLVar, y: LLVar, x: LLVar) => MGoal);
    } else {
        throw new Error("Unsupported arity");
    }
}
...
export function freshInternal(f: (v: LLVar) => MGoal): MGoal {
    return (sc: State): MStream => sc.withLvar((ff) => (sc2): MStream => {
        const f3 = f(ff);
        return f3(sc2);
    }, '$&');
}

export function freshInternal2(f: (v: LLVar, v2: LLVar) => MGoal): MGoal {
    return freshInternal((v) => freshInternal((v2) => f(v, v2)));
}

export function freshInternal3(f: (v: LLVar, v2: LLVar, v3: LLVar) => MGoal): MGoal {
    return freshInternal((v) => freshInternal2((v2, v3) => f(v, v2, v3)));
}

export function freshInternal4(f: (v: LLVar, v2: LLVar, v3: LLVar, v4: LLVar) => MGoal): MGoal {
    return freshInternal((v) => freshInternal3((v2, v3, v4) => f(v, v2, v3, v4)));
}

export function freshInternal5(f: (v: LLVar, v2: LLVar, v3: LLVar, v4: LLVar, v5: LLVar) => MGoal): MGoal {
    return freshInternal((v) => freshInternal4((v2, v3, v4, v5) => f(v, v2, v3, v4, v5)));
}

export function freshInternal6(f: (v: LLVar, v2: LLVar, v3: LLVar, v4: LLVar, v5: LLVar, v6: LLVar) => MGoal): MGoal {
    return freshInternal((v) => freshInternal5((v2, v3, v4, v5, v6) => f(v, v2, v3, v4, v5, v6)));
}
...
export function fresh5(
    f: (v: LLVar, v2: LLVar, v3: LLVar, v4: LLVar, v5: LLVar) => MGoal
): MGoal {
    return (sc) => [
        () => freshInternal5(f)(sc)
    ];
...
export function fresh6(
    f: (v: LLVar, v2: LLVar, v3: LLVar, v4: LLVar, v5: LLVar, v6: LLVar) => MGoal
): MGoal {
    return (sc) => [
        () => freshInternal6(f)(sc)
    ];
...
export function freshNomInternal2(
    ...
    return freshNomInternal((v) => freshNomInternal((v2) => fn(v, v2)));
}

export function freshNomInternal3(
    fn: (v: LNom, v2: LNom, v3: LNom) => MGoal
): MGoal {
    return freshNomInternal((v) => freshNomInternal2((v2, v3) => fn(v, v2, v3)));
}

export function freshNomInternal4(
    fn: (v: LNom, v2: LNom, v3: LNom, v4: LNom) => MGoal
): MGoal {
    return freshNomInternal((v) => freshNomInternal3((v2, v3, v4) => fn(v, v2, v3, v4)));
}

export function freshNomInternal5(
    fn: (v: LNom, v2: LNom, v3: LNom, v4: LNom, v5: LNom) => MGoal
): MGoal {
    return freshNomInternal((v) => freshNomInternal4((v2, v3, v4, v5) => fn(v, v2, v3, v4, v5)));
}

export function freshNomInternal6(
    fn: (v: LNom, v2: LNom, v3: LNom, v4: LNom, v5: LNom, v6: LNom) => MGoal
): MGoal {
    return freshNomInternal((v) => freshNomInternal5((v2, v3, v4, v5, v6) => fn(v, v2, v3, v4, v5, v6)));
}
