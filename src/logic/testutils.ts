...
import { fresh5, fresh2, freshNom, fresh, freshNom2, freshNom3, fresh4, fresh3 } from "./AnyFreshFn";
...
const qapp = (
  ...
  return makeList([makeLiteral("app"), makeList([rator, rand])]);
};

export const qappVV = (a: Term, b: Term) => qapp(qvar(a), qvar(b));
...
export const lamTie2 = (a: string | trm.LNom, b: CleanOutput | trm.LTerm): CleanOutput => {
...
export const qapp2 = (r1: CleanOutput | trm.LTerm, b1: CleanOutput | trm.LTerm): CleanOutput => {
...
export const qvar2 = (t: CleanOutput | trm.LTerm): CleanOutput => {
...
export const tieTag = (str: string | trm.LNom, tr: Term | CleanOutput): CleanOutput => {
  return {
...
export const suspTag = (str: string | trm.LNom, strB: string | trm.LNom, tr: Term | CleanOutput): CleanOutput => {
  return {
    swap: [cleanOutputOrReturn(str), cleanOutputOrReturn(strB)],
    term: tr instanceof trm.LTerm ? tr.cleanOutput() : tr,
  }
}
...
function cleanOutputOrReturn(str: string | trm.LNom): CleanOutput {
...
function stepEqualo(t1: LTerm, t2: LTerm, depth = 0): MGoal {
  return either(
    eq(t1, t2),
    fresh((t1Hat) => {
      return all(
...
export function stepEqualo2(t1: LTerm, t2: LTerm, depth = 0): MGoal {
