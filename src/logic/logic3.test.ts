...
import {makeList, makeLiteral, qlvar, qnom} from './makelvar';
import {all, either, eq, run1} from './index';
import { fresh, fresh2, fresh3, fresh4, freshNom, freshNom2, freshNom4 } from "./AnyFreshFn";
      ...
      run1(
        ...
        fresh2((t, u) => {
          return freshNom4((a, b, c, d) => {
            return all(
              ezq(["lam", ezTie(a, ["lam", ezTie(b, qvar(a))])], t),
              ezq(["lam", ezTie(c, ["lam", ezTie(d, qvar(c))])], u),
              ezq(t, u),
            );
          });
        }),
      ...
      run1(
        ...
        fresh2((t, u) => {
          return freshNom4((a, b, c, d) => {
            return all(
              ezq(["lam", ezTie(a, ["lam", ezTie(b, qvar(a))])], t),
              ezq(["lam", ezTie(c, ["lam", ezTie(d, qvar(d))])], u),
              ezq(t, u),
            );
          });
        }),
    ...
    expect(
      run1(
        ...
        freshNom2((a, b) => {
          return fresh2((x, y) => {
            return all(
              eq(ezTie(a, ezTie(a, x)), ezTie(a, ezTie(b, y))),
              ezq([x, y], qlvar.q),
            );
          });
        }),
      ...
      run1(
        ...
        freshNom2((a, b) => {
          return fresh2((x, y) => {
            return all(
              either(
                ezq(ezTie(a, ezTie(b, [x, b])), ezTie(b, ezTie(a, [a, x]))),
                ezq(ezTie(a, ezTie(b, [y, b])), ezTie(b, ezTie(a, [a, x]))),
                ezq(ezTie(a, ezTie(b, [b, y])), ezTie(b, ezTie(a, [a, x]))),
                ezq(ezTie(a, ezTie(b, [b, y])), ezTie(a, ezTie(a, [a, x]))),
              ),
              ezq([x, y], qlvar.q),
            );
          });
